...
export default class GenreCard extends Component {
    ...
    render() {
        ...
        console.log(this.props.genres[0]);
    //  console.log(this.props.genres[0].genre); // breaks
        return (
            <>
                <div className="genre-cards-wrapper">
                    ...
                    <div className="genre-card">
                        ...
                        <div className="genre-card-description">
                            ...
                            folk revival. Some types of folk music may be called world music.</p>
                        </div>
                    </div>
                    ...
                    <div className="genre-card">
                        ...
                        <div className="genre-card-description">
                            ...
                            and ragtime. Jazz is seen by many as "America's classical music."</p>
                        </div>
                    </div>
                </div>
